...
export const Details = () => {
    ...
    const colunasConsultas = [{ key: "desc" }, { key: "Detalhes", type: "button", onclick: detalhesConsulta }];
        ...
        <>
            <Container>
                <Header>
                    ...
                    <RowBox width="auto">
                        <Button onClick={() => Switch("ModalHistoricoFamiliar")}>Histórico Familiar</Button>
                ...
                <Content>
                    <ColumnBox height="100%">
                        <Datagrid title="Histórico" columns={colunasHistorico} data={diagnosticos}></Datagrid>
                    </ColumnBox>
                    <ColumnBox height="100%">
                        <Datagrid title="Consultas" columns={colunasConsultas} data={consultas}></Datagrid>
                    </ColumnBox>
                </Content>
            </Container>
