...
export const Details = () => {
    ...
    const colunasConsultas = [
        ...
        { label: "Ação", key: "Diagnostico", type: "button", onclick: detalhesConsulta },
    ];
        ...
        <>
            <Container>
                <Header>
                    ...
                    <RowBox width="auto">
                        <Button onClick={() => Switch("ModalAntecedentes")}>Antecedentes</Button>
                ...
                <Content>
                    <ColumnBox height="100%">
                        <Datagrid title="Histórico" columns={colunasHistorico} data={historico}></Datagrid>
                    </ColumnBox>
                    <ColumnBox height="100%">
