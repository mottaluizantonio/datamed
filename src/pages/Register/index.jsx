...
export const Register = () => {
    ...
    const novoUsuario = async (registros) => {
        registros.celular = registros.celular.match(/\d+/g).join("");
        registros.cpf = registros.cpf.match(/\d+/g).join("");
        registros.tipo = type;
                    ...
                    <FormBox height="100%" onSubmit={handleSubmit(novoUsuario)}>
                        <ColumnBox height="100%" overflow="auto">
                            ...
                            <RowBox>
                                ...
                                <Input register={register} name="celular" errorMsg={errors.celular?.message} label="Celular" placeholder="Seu Número" mask="(99) 99999-9999" />
                            </RowBox>
                            <RowBox>
                            ...
                            <RowBox>
                                <Input register={register} name="cpf" errorMsg={errors.cpf?.message} label="CPF" placeholder="Insira seu CPF" mask="999.999.999-99" />
                                <Input register={register} name="crm" errorMsg={errors.crm?.message} label="CRM" placeholder="Insira seu CRM" mask="999999" />
                            </RowBox>
                            <RowBox>
