...
export const Container = styled.section`
  ...
  justify-content: ${({ style }) =>
    !!style?.justifyContent ? style.justifyContent : "space-between"};
  align-items: ${({ style }) =>
    !!style?.alignItems ? style.alignItems : "center"};
  gap: ${({ style }) => (!!style?.gap ? style.gap : "15px")};
  background-color: ${(prop) =>
    !!prop.bgColor
      ? colorManager("background", prop.bgColor)
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.container)};
...
export const Header = styled.section`
  ...
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.header)};
  color: ${colorManager("color", palette.presets.font)};
  overflow: ${(prop) =>
    !!prop?.overflow
      ? prop.overflow
...
export const Content = styled.section`
  ...
  justify-content: ${(prop) =>
    !!prop?.justifyContent
      ...
      : "initial"};
  justify-content: ${({ style }) =>
    !!style?.justifyContent ? style.justifyContent : "initial"};
  align-items: ${({ style }) =>
    !!style?.alignItems ? style.alignItems : "center"};
  gap: ${({ style }) => (!!style?.gap ? style.gap : "15px")};
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.content)};
  color: ${colorManager("color", palette.presets.font)};
  overflow: ${(prop) =>
    !!prop?.overflow
      ? prop.overflow
  ...
  img {
    ...
    height: ${({ style }) =>
      !!style?.img?.height ? style.img.height : "auto"};
    border-radius: ${({ style }) =>
...
export const ColumnBox = styled.section`
  ...
  justify-content: ${({ style }) =>
    !!style?.justifyContent ? style.justifyContent : "initial"};
  align-items: ${({ style }) =>
    !!style?.alignItems ? style.alignItems : "initial"};
  gap: ${({ style }) => (!!style?.gap ? style.gap : "15px")};
  box-sizing: border-box;
  overflow: ${(prop) =>
    !!prop?.overflow
  ...
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.ColumnBox)};
  cursor: ${({ style }) => (!!style?.cursor ? style.cursor : "auto")};
  img {
...
export const RowBox = styled.div`
  ...
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.RowBox)};
  cursor: ${({ style }) => (!!style?.cursor ? style.cursor : "auto")};
  img {
    width: ${({ style }) => (!!style?.img?.width ? style.img.width : "100%")};
    height: ${({ style }) =>
...
export const FormBox = styled.form`
  ...
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.form)};
  cursor: ${({ style }) => (!!style?.cursor ? style.cursor : "auto")};
  img {
    width: ${({ style }) => (!!style?.img?.width ? style.img.width : "100%")};
    height: ${({ style }) =>
...
export const FieldBox = styled.div`
  ...
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.FieldBox)};
  label {
    width: 100%;
    height: auto;
    font-size: 15px;
...
export const Button = styled.button`
  ...
  height: ${(prop) =>
    !!prop?.height
      ...
      : "48px"};
  background-color: ${(prop) =>
    colorManager("background", prop.bgColor || palette.presets.button)};
  color: ${(prop) =>
    colorManager("color", prop.bgColor || palette.presets.button)};
  border: 1.2px solid
    ${(prop) =>
      colorManager("background", prop.bgColor || palette.presets.button)};
  padding: ${(prop) =>
  ...
  :hover {
    background-color: ${(prop) =>
      colorManager("hover", prop.bgColor || palette.presets.button)};
    border: 1.2px solid
      ${(prop) => colorManager("hover", prop.bgColor || palette.presets.button)};
    cursor: pointer;
  }
  :disabled {
    background-color: ${(prop) =>
      colorManager("disable", prop.bgColor || palette.presets.button)};
    border: 1.2px solid
      ${(prop) =>
        colorManager("disable", prop.bgColor || palette.presets.button)};
    cursor: not-allowed;
    :hover {
      background-color: ${(prop) =>
        colorManager("disableHover", prop.bgColor || palette.presets.button)};
      border: 1.2px solid
        ${(prop) =>
          colorManager("disableHover", prop.bgColor || palette.presets.button)};
    }
...
export const Text = styled.span`
  ...
  color: ${(prop) =>
    !!prop?.color
      ? colorManager("color", prop.color)
      : !!prop?.style?.color
      ? prop.style.color
      : colorManager("color", palette.presets.font)};
  cursor: ${({ style }) => (!!style?.cursor ? style.cursor : "default")};
`;
export const ModalBox = styled.section`
  ...
  background-color: ${(prop) =>
    !!prop.bgColor
      ...
      : !!prop?.backgroundColor
      ? prop.backgroundColor
      : colorManager("background", palette.presets.modal)};
  box-sizing: border-box;
  opacity: ${({ style }) => (!!style?.opacity ? style.opacity : "initial")};
  img {
    width: ${({ style }) => (!!style?.img?.width ? style.img.width : "100%")};
...
export const Input = ({
  ...
  return (
    ...
    >
      ...
      <Text
        color="error"
        style={{ padding: "0 10px", fontSize: "15px", fontWeight: 500 }}
      >
        {errorMsg}
      </Text>
    </FieldBox>
...
export const Select = ({
  ...
  return (
    ...
    >
      ...
      <select {...register(name)} {...rest}>
        {!!options &&
          options.map((option, i) => (
            <option
              hidden={!!option?.value ? false : true}
              key={i}
      ...
      <Text
        color="error"
        style={{ padding: "0 10px", fontSize: "15px", fontWeight: 400 }}
      >
        {errorMsg}
      </Text>
    </FieldBox>
...
export const Datagrid = ({
  ...
  const {
    ...
    showTitle = true,
    showFilter = true,
    emptyMsg = "Nada foi encontrado!",
  } = options;
  const onClickButton = (callback, iten) =>
    callback !== undefined
      ? callback(iten)
      : console.error("error: missing key 'onclick' in column object");
  return (
        ...
        {data !== undefined && data.length > 0 ? (
          data.map((iten, i) => (
            <ContentLine key={i} width={`${iten.width}%`}>
              {columns.map(
                ({ key = "", width = 100, type = "text", onclick }, i) => {
                  return type.toLowerCase() === "text" ? (
                    ...
                    <LineField key={`${key}_button-${i}`} width={`${width}%`}>
                      <Button onClick={() => onClickButton(onclick, iten)}>
                        {key}
                      </Button>
                    </LineField>
                  ) : (
